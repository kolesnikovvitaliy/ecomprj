...
class Vendor(models.Model):
    ...
    description = models.TextField(
        null=True, blank=True, default="I am amazing Vendor"
    )

    address = models.CharField(max_length=100, default="123 Main Street")
    contact = models.CharField(max_length=100, default="+1 (123) 456")
...
class Product(models.Model):
    ...
    price = models.DecimalField(
        max_digits=999999999999999, decimal_places=2, default="1.99"
    )
    old_price = models.DecimalField(
        max_digits=999999999999999, decimal_places=2, default="2.99"
    )
